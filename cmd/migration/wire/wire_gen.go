...
var repositorySet = wire.NewSet(repository.NewDB, repository.NewRedis, repository.NewRepository, repository.NewUserRepository, repository.NewProfileRepository, repository.NewWorkspaceRepository, repository.NewDocumentRepository, repository.NewCollectionRepository, repository.NewTagRepository, repository.NewMemberRepository, repository.NewCommentRepository)
