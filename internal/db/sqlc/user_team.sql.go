...
func (q *Queries) GetTeamsByUserID(ctx context.Context, userID pgtype.Text) ([]pgtype.Text, error) {
...
func (q *Queries) GetUsersByTeamID(ctx context.Context, teamID pgtype.Text) ([]pgtype.Text, error) {
...
func (q *Queries) RemoveAllUsersFromTeam(ctx context.Context, teamID pgtype.Text) error {
