...
type UserRepository interface {
	...
	GetUserByWorkspaceID(ctx context.Context, workspaceID uint) (*model.User, error)
	GetUserByUserID(ctx context.Context, userID uint) (*model.User, error)
...
func (r *userRepository) GetUserByWorkspaceID(ctx context.Context, workspaceID uint) (*model.User, error) {
	var user model.User
...
func (r *userRepository) GetUserByUserID(ctx context.Context, userID uint) (*model.User, error) {
	var user model.User
